...
class TestGemma4StaticRuntimeShape(unittest.TestCase):
    ...
    def test_default_shape_matches_processor_contract(self):
        ...
        self.assertEqual(shape.visual_grid_height, 14)
        self.assertEqual(shape.visual_grid_width, 19)
        self.assertEqual(shape.patch_grid_height, 42)
        self.assertEqual(shape.patch_grid_width, 57)
        self.assertEqual(shape.num_valid_patches, 2_394)
        self.assertEqual(shape.num_patches, 2_520)
        self.assertEqual(shape.num_padding_patches, 126)
        self.assertEqual(shape.num_padding_soft_tokens, 14)
    ...
    def test_case_shape_helpers_select_static_dimensions(self):
        ...
        self.assertEqual(embedder._visual_token_seq_len(default=16), 266)
