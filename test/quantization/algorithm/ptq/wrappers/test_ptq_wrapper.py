...
from tico.experimental.quantization.algorithm.ptq.observers import PercentileObserver
...
class TestPTQWrapper(unittest.TestCase):
    ...
    def test_weight_fake_quant_channelwise(self):
        ...
        assert isinstance(self.wrapper.wrapped.weight_obs, ObserverBase)
...
class TestPTQSmoke(unittest.TestCase):
    ...
    def test_smoke_forward_quantized(self):
        ...
        with torch.no_grad():
            ...
            fp32_out = self.model.linear.wrapped.module(*inp)  # type: ignore[operator]
