...
Tests for the generic element-wise quant wrappers:
    ...
    • QuantSigmoid  (nn.Sigmoid → torch.sigmoid)
    • QuantTanh     (nn.Tanh    → torch.tanh)
    • QuantReLU     (nn.ReLU    → torch.relu)
    • QuantGELU     (nn.GELU    → F.gelu)
...
from tico.experimental.quantization.algorithm.ptq.mode import Mode
...
from tico.experimental.quantization.algorithm.ptq.wrappers.quant_elementwise import (
    QuantGELU,
    QuantReLU,
    QuantSigmoid,
    QuantTanh,
...
from tico.experimental.quantization.algorithm.ptq.wrappers.registry import lookup
