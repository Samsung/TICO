...
class TestQuantQwen3VLVisionModel(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            cls.transformers_version = "old"
        else:
            # transformers version 5.3.0
            cls.transformers_version = "new"
    ...
    def test_output_structure(self):
        ...
        merged_hidden_states = (
            q_out.pooler_output if self.transformers_version == "new" else q_out[0]
        )
    ...
    def test_different_grid_sizes(self):
        ...
        for grid_thw_list, description in test_cases:
            with self.subTest(description=description):
                ...
                merged_hidden_states = (
                    q_out.pooler_output
                    if self.transformers_version == "new"
                    else q_out[0]
                )
