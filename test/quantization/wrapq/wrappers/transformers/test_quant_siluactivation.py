...
class TestQuantSiLUActivation(unittest.TestCase):
    def setUp(self):
        from tico.quantization.wrapq.wrappers.transformers.quant_siluactivation import (
            QuantSiLUActivation,
        )
        ...
        self.fp_silu = SiLUActivation()
        self.qsilu = QuantSiLUActivation(self.fp_silu)  # default uint8
    ...
    def test_dtype_override(self):
        ...
        qsilu = QuantSiLUActivation(self.fp_silu, qcfg=cfg)
