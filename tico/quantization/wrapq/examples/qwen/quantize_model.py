...
"""
Example script for quantizing and converting Qwen3VLModel to Circle format.

This script demonstrates:
1. Loading a Qwen3VL vision-language model
...
if not has_transformers_for("qwen3-vl"):
    print(
        "Error: Required transformers package not installed. Cannot test Qwen3VLModel."
    )
    sys.exit(1)
...
def main():
    ...
    filename = "qwen3vl_model.q.circle"
