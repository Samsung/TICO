...
def main():
    ...
    #
    # The QuantGemma4ForConditionalGeneration.as_export_module() returns a
    # Gemma4ForConditionalGenerationExportAdapter whose forward() delegates
    # to forward_export(), which:
    #   1. Runs the model export adapter (text decoder + final norm)
    #   2. Applies lm_head with logits_to_keep slicing
    #   3. Applies logit softcapping with fake-quantization
    # ------------------------------------------------------------------
    ...
    filename = "gemma4_for_conditional_generation.q.circle"
