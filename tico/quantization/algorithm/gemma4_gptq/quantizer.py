    ...
    def _quantize_text_layers(
        ...
        **Key difference from Qwen3-VL**: Gemma4 uses mixed layer types
        ...
        def capture_lm_forward(_lm, *args, **kwargs):
            ...
            if (
                hasattr(language_model, "hidden_size_per_layer_input")
                and language_model.hidden_size_per_layer_input
            ):
        ...
        for layer_idx, layer in enumerate(
            ...
            stage_name = module_name.get(layer, f"language_model.layers.{layer_idx}")
