...
def traced_run_decompositions(exported_program: ExportedProgram):
    """
    Run decompositions while preserving certain ops.
    
    Args:
        exported_program: The ExportedProgram to decompose
...
def canonicalize(exported_program: ExportedProgram, config: CompileConfigBase):
    """
    Perform canonicalization passes on an ExportedProgram.
    
    Args:
        exported_program: The ExportedProgram to canonicalize
        config: Compile configuration with optional settings
    
    Returns:
        The canonicalized ExportedProgram
    """
...
def remove_dead_placeholders(exported: ExportedProgram) -> ExportedProgram:
    """
    Remove dead placeholder nodes from an ExportedProgram.
    
    Args:
        exported: The ExportedProgram to clean up
    
    Returns:
        The cleaned ExportedProgram
    """
    # Find dead placeholders in the graph
